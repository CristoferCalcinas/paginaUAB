          ...
          <section className="relative flex h-32 w-2/3 items-end bg-gray-900 lg:h-full">
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              <p className="mt-4 leading-relaxed text-white/90">
                Déjanos tus datos y te daremos orientación vocacional
                especializada.
              </p>
            </div>
          </section>
            ...
            <div className="">
              <form action="#" className="flex flex-col space-y-10">
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  <button className="inline-block shrink-0 rounded-md border border-[#0000ff] bg-[#0000ff] px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
